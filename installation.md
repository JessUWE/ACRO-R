...
ACRO-R requires: - R version 4.0 or higher - Python 3.10+ or higher with
the ACRO Python package installed
...
detailed [installation guide](INSTALL.md) or check the [GitHub
